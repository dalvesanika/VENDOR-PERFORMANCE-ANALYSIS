...
def creat_vendor_summary(conn):
    '''this function wil merge the difference tables to get the overall vendor summary and adding new colounm in resultant data'''
...
def clean_data(df):
    '''this function will clenthe data'''
